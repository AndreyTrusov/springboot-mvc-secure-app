...
CREATE TABLE `event_schedule` (
  ...
  KEY `learning_center_id` (`learning_center_id`),
  CONSTRAINT `event_schedule_ibfk_1` FOREIGN KEY (`event_id`) REFERENCES `event` (`event_id`) ON DELETE CASCADE,
  CONSTRAINT `event_schedule_ibfk_2` FOREIGN KEY (`learning_center_id`) REFERENCES `learning_center` (`learning_center_id`) ON DELETE CASCADE
